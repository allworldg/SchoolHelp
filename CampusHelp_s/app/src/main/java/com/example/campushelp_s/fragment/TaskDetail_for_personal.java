...
public class TaskDetail_for_personal extends Fragment {
    ...
    /*传入task与user的构造函数*/
    public TaskDetail_for_personal(Task task,User user){
    ...
    /*传入task与user的构造函数*/
    public TaskDetail_for_personal(Task task){
        this.currentTask=task;
        this.currentTaskObjectId=task.getObjectId();
    }
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        FrameLayout replace = getActivity().findViewById(R.id.collection_replace);
        replace.setVisibility(View.VISIBLE);
        Button bt_jump_square = mRoot.findViewById(R.id.bt_jump_square);
        bt_jump_square.setVisibility(View.INVISIBLE);
        //textView.setText();
    ...
    public void onStop() {
        super.onStop();
        FrameLayout replace = mActivity.findViewById(R.id.collection_replace);
